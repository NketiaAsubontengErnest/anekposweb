...
class Model extends Database
{
    ...
    public function update($id, $data, $collumn = 'id')
    {
        $str = "";
        ...
        $str = trim($str, ",");
        $data['id'] = $id;
        $query = "UPDATE $this->table SET $str WHERE $collumn=:id";
        return $this->query($query, $data);
    }

    public function delete($id, $collumn = 'id')
    {
        $data['id'] = $id;
        $query = "DELETE FROM $this->table WHERE $collumn = :id";
        return $this->query($query, $data);
    }
}
